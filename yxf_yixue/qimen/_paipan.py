...
class Paipan:
    ...
    def paipan(self, datetime_obj, calendar, bujufangfa):
        ...
        self.Xinxi = {'节气': self.solarTerm['节气名称'], '月将': self.solarTerm['文本'][-5:-4], '阴阳': '', '三元': '', '三元补充': {}, '遁局': '', '旬首': '', '值符': '', '值使': '', '布局方法': bujufangfa}
    ...
    def _xinxi(self):
        ...
        self.Xinxi['三元补充']['上元'] = dunjubiao[self.Xinxi['节气']][0]
        self.Xinxi['三元补充']['中元'] = dunjubiao[self.Xinxi['节气']][1]
        self.Xinxi['三元补充']['下元'] = dunjubiao[self.Xinxi['节气']][2]
